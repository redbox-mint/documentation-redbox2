...
Preparation 
===========
* This install guide has been tested on VM instances running Ubuntu 16.04 Xenial
...
Additional information on installing Node.js can be found [here](https://nodejs.org/en/download/package-manager/#debian-and-ubuntu-based-linux-distributions).
...
Instructions on installing MongoDB for Ubuntu can be found [here](https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/). Warning, these instructions change frequently, so rather than us documenting it here it is best to use their installation commands. Just follow the instructions for *installing the .deb packages*.
...
**Create the web server httpd.conf file.** 
...
and follow the instructions (if any) for pasting startup commands, e.g: * sudo env PATH=$PATH:/usr/bin /usr/lib/node_modules/pm2/bin/pm2 startup systemd -u ubuntu --hp /home/ubuntu *
